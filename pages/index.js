        ...
        <main className='h-screen flex items-center justify-center'>
          <form onSubmit={formik.handleSubmit} className='bg-white flex rounded-lg w-1/2 font-latoRegular'>
            <div className='flex-1 text-gray-700 p-20'>
              ...
              <p className='text-lg text-gray-500'>join our E-learning platform today and unlock over 500+ courses and digital assets ready to dawnload.</p>
              <div className='mt-6'>
              ...
              <select className='border-2 border-gray-500 p-2 rounded-md w-1/2 focus:border-teal-500 focus:ring-teal-500'
            ...
            <div className='relative flex-1'>
              <Image src={formImg} alt="image" fill priority className='object-cover rounded-lg'/>
            </div>
          </form>
        </main>      
    </m.div>
